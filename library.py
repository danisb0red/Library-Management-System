   ...
   def show_library():
    if (len(Library.books_list)==0):
      print("No Books in Library")
        ...
        print("Books :\n")
        for temp_book in Library.books_list:
         print("Title: ",temp_book.getTitle()," Status:", "available" if temp_book.availability_status else "not available")
         print("\n")
    if (len(Library.magazines_list)==0):
      ...
      print("Magazines :\n")
      for temp_mag in Library.magazines_list:
         print("Title: ",temp_mag.getTitle()," Status:", "available" if temp_mag.availability_status else "not available")
         print("\n")
